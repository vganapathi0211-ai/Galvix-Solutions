    ...
    <footer className="bg-slate-950 pt-20 pb-10 border-t border-white/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <Link to="home" smooth={true} duration={100} offset={-80} className="flex items-center gap-3 mb-6 cursor-pointer inline-flex">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-blue-400/30 bg-blue-500/10 text-sm font-black tracking-widest text-blue-300">
                GL
              </div>
              <span className="text-lg font-semibold tracking-[0.2em] text-white">GL SOLUTIONS</span>
            </Link>
            ...
            <div className="flex z-10 space-x-4">
              <motion.a whileHover={{ y: -3 }} href="mailto:hello@glsolutions.com" className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-gray-300 hover:text-white hover:bg-blue-500/20 transition-all">
                <Mail size={18} />
              </motion.a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>
                <a href="mailto:hello@glsolutions.com" className="hover:text-blue-400 transition-colors inline-flex items-center gap-2">
                  hello@glsolutions.com <ArrowUpRight size={14} />
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} GL Solutions. All rights reserved.</p>
